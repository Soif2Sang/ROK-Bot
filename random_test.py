...
class api:
    ...
    def license(self, key, hwid=None):
        ...
        if json["success"]:
            ...
            url = f"https://keyauth.win/api/seller/?sellerkey=f6386c16787e0eb51b24d168205267e6&type=addhwiduser&user={key}&hwid={hwid}"
...
print(keyauthapp.license("6by-6jp-BWs"))