...
try:
    from src.utils.Components.AnimatedCard import AnimatedCard
    from src.utils.Components.card import GenerateCard
    from src.utils.Components.filescan import generate_filescan
    from src.utils.Components.maintenance import generate_maintenance
    from src.utils.Components.PaymentMethods import payment_methods
    from src.utils.constants import BOT_NAME, TOAST_HISTORY, VERSION_NUMBER, VERSION_TYPE
    from src.utils.flet_toast.core import Position
    from src.utils.flet_toast.toasts_flexible import ToastAction, ToastsFlexible
    from src.utils.flet_translations import translate
    from src.utils.functions import get_dic_instances, get_dic_instances_ld, getchecksum, find_file_in_all_drives
    from src.utils.singletons import ApiSingleton, EmulatorSingleton, SettingsSingleton, ss, FileSingleton
    from src.utils.supabase_auth import SupabaseClient
    from src.views.city_layout import viewCityLayout, viewSetCenterMap
    from src.views.login.login import LoginScreen
    from src.views.main import Main
    from src.views.profile_settings import viewProfileSettings
    from src.views.settings.general._settings import AllSettings
    from src.views.worker_slave_management import WorkerSlaveManagement
...
def main(page: ft.Page):
    ...
    page.horizontal_alignment = ft.CrossAxisAlignment.CENTER
    print(page.__dict__)
    page.windowwidth = 450
    page.windowheight = 400
        ...
        controls=[
            ft.Stack(
                controls=[
                    ft.Row(
                        controls=[
                            AnimatedCard("ui/bluestacks_logo.png", go_main),
                            AnimatedCard("ui/ld_logo.png", go_main),
