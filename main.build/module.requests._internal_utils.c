...
static PyCodeObject *codeobj_b597c3779c6232f4ce27a5e4f806cc00;
static PyCodeObject *codeobj_4c0190b74f102e4bd6713e06f73006df;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[30]); CHECK_OBJECT(module_filename_obj);
    codeobj_3580093ce57f51f70ad9e71f982967e8 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[31], mod_consts[31], NULL, NULL, 0, 0, 0);
    codeobj_b597c3779c6232f4ce27a5e4f806cc00 = MAKE_CODE_OBJECT(module_filename_obj, 23, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[28], mod_consts[28], mod_consts[32], NULL, 2, 0, 0);
    codeobj_4c0190b74f102e4bd6713e06f73006df = MAKE_CODE_OBJECT(module_filename_obj, 36, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[29], mod_consts[29], mod_consts[33], NULL, 1, 0, 0);
}
...
static PyObject *impl_requests$_internal_utils$$$function__1_to_native_string(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_b597c3779c6232f4ce27a5e4f806cc00;
    ...
    int tmp_res;
    static struct Nuitka_FrameObject *cache_frame_b597c3779c6232f4ce27a5e4f806cc00 = NULL;
    ...
    // Tried code:
    if (isFrameUnusable(cache_frame_b597c3779c6232f4ce27a5e4f806cc00)) {
        Py_XDECREF(cache_frame_b597c3779c6232f4ce27a5e4f806cc00);

#if _DEBUG_REFCOUNTS
        if (cache_frame_b597c3779c6232f4ce27a5e4f806cc00 == NULL) {
...
#endif
        cache_frame_b597c3779c6232f4ce27a5e4f806cc00 = MAKE_FUNCTION_FRAME(codeobj_b597c3779c6232f4ce27a5e4f806cc00, module_requests$_internal_utils, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    assert(cache_frame_b597c3779c6232f4ce27a5e4f806cc00->m_type_description == NULL);
    frame_b597c3779c6232f4ce27a5e4f806cc00 = cache_frame_b597c3779c6232f4ce27a5e4f806cc00;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b597c3779c6232f4ce27a5e4f806cc00);
    assert(Py_REFCNT(frame_b597c3779c6232f4ce27a5e4f806cc00) == 2);
    ...
    branch_no_1:;
    {
        ...
        frame_b597c3779c6232f4ce27a5e4f806cc00->m_frame.f_lineno = 31;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_b597c3779c6232f4ce27a5e4f806cc00, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_b597c3779c6232f4ce27a5e4f806cc00->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_b597c3779c6232f4ce27a5e4f806cc00, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_b597c3779c6232f4ce27a5e4f806cc00,
        type_description_1,
        par_string,
        par_encoding,
        var_out
    ...
    if (frame_b597c3779c6232f4ce27a5e4f806cc00 == cache_frame_b597c3779c6232f4ce27a5e4f806cc00) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_b597c3779c6232f4ce27a5e4f806cc00);
        cache_frame_b597c3779c6232f4ce27a5e4f806cc00 = NULL;
    }

    assertFrameObject(frame_b597c3779c6232f4ce27a5e4f806cc00);
...
static PyObject *impl_requests$_internal_utils$$$function__2_unicode_is_ascii(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_4c0190b74f102e4bd6713e06f73006df;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    int tmp_res;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    static struct Nuitka_FrameObject *cache_frame_4c0190b74f102e4bd6713e06f73006df = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_4c0190b74f102e4bd6713e06f73006df)) {
        Py_XDECREF(cache_frame_4c0190b74f102e4bd6713e06f73006df);

#if _DEBUG_REFCOUNTS
        if (cache_frame_4c0190b74f102e4bd6713e06f73006df == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_4c0190b74f102e4bd6713e06f73006df = MAKE_FUNCTION_FRAME(codeobj_4c0190b74f102e4bd6713e06f73006df, module_requests$_internal_utils, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_4c0190b74f102e4bd6713e06f73006df->m_type_description == NULL);
    frame_4c0190b74f102e4bd6713e06f73006df = cache_frame_4c0190b74f102e4bd6713e06f73006df;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_4c0190b74f102e4bd6713e06f73006df);
    assert(Py_REFCNT(frame_4c0190b74f102e4bd6713e06f73006df) == 2);
    ...
    // Tried code:
    {
        ...
        frame_4c0190b74f102e4bd6713e06f73006df->m_frame.f_lineno = 45;
    ...
    if (exception_keeper_tb_1 == NULL) {
        exception_keeper_tb_1 = MAKE_TRACEBACK(frame_4c0190b74f102e4bd6713e06f73006df, exception_keeper_lineno_1);
    } else if (exception_keeper_lineno_1 != 0) {
        exception_keeper_tb_1 = ADD_TRACEBACK(exception_keeper_tb_1, frame_4c0190b74f102e4bd6713e06f73006df, exception_keeper_lineno_1);
    }
    ...
    if (exception_tb && exception_tb->tb_frame == &frame_4c0190b74f102e4bd6713e06f73006df->m_frame) frame_4c0190b74f102e4bd6713e06f73006df->m_frame.f_lineno = exception_tb->tb_lineno;
    type_description_1 = "o";
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_4c0190b74f102e4bd6713e06f73006df, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_4c0190b74f102e4bd6713e06f73006df->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_4c0190b74f102e4bd6713e06f73006df, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_4c0190b74f102e4bd6713e06f73006df,
        type_description_1,
        par_u_string
    );
    ...
    // Release cached frame if used for exception.
    if (frame_4c0190b74f102e4bd6713e06f73006df == cache_frame_4c0190b74f102e4bd6713e06f73006df) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_4c0190b74f102e4bd6713e06f73006df);
        cache_frame_4c0190b74f102e4bd6713e06f73006df = NULL;
    }

    assertFrameObject(frame_4c0190b74f102e4bd6713e06f73006df);
...
static PyObject *MAKE_FUNCTION_requests$_internal_utils$$$function__1_to_native_string(PyObject *defaults) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_b597c3779c6232f4ce27a5e4f806cc00,
        defaults,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_requests$_internal_utils$$$function__2_unicode_is_ascii() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_4c0190b74f102e4bd6713e06f73006df,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
