...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("oauthlib.uri_validate"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_oauthlib$uri_validate(void) {
...
static PyObject *impl_oauthlib$uri_validate$$$function__1_is_uri(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_d20d465d2683cd5727fd41837ae78120 = MAKE_FUNCTION_FRAME(codeobj_d20d465d2683cd5727fd41837ae78120, module_oauthlib$uri_validate, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_d20d465d2683cd5727fd41837ae78120);
...
static PyObject *impl_oauthlib$uri_validate$$$function__2_is_uri_reference(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_b835b0c92cb4e4802ba6c343d4321bf2)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b835b0c92cb4e4802ba6c343d4321bf2 = MAKE_FUNCTION_FRAME(codeobj_b835b0c92cb4e4802ba6c343d4321bf2, module_oauthlib$uri_validate, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b835b0c92cb4e4802ba6c343d4321bf2);
...
static PyObject *impl_oauthlib$uri_validate$$$function__3_is_absolute_uri(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_d37c2d52c6dde32bf0c1c03267cdf2da)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_d37c2d52c6dde32bf0c1c03267cdf2da = MAKE_FUNCTION_FRAME(codeobj_d37c2d52c6dde32bf0c1c03267cdf2da, module_oauthlib$uri_validate, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_d37c2d52c6dde32bf0c1c03267cdf2da);
...
PyObject *modulecode_oauthlib$uri_validate(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("oauthlib.uri_validate: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("oauthlib.uri_validate: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_oauthlib$uri_validate);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_5e81c7a6ec70dfa859430a836ae50bf2);
