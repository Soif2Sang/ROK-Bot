...
static PyCodeObject *codeobj_1d033c00da0d4a9c8feead1ea9c59233;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[17]); CHECK_OBJECT(module_filename_obj);
    codeobj_1d033c00da0d4a9c8feead1ea9c59233 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[18], mod_consts[18], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_1d033c00da0d4a9c8feead1ea9c59233;
    ...
    frame_1d033c00da0d4a9c8feead1ea9c59233 = MAKE_MODULE_FRAME(codeobj_1d033c00da0d4a9c8feead1ea9c59233, module_urllib3$packages);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1d033c00da0d4a9c8feead1ea9c59233);
    assert(Py_REFCNT(frame_1d033c00da0d4a9c8feead1ea9c59233) == 2);
    ...
    // Framed code:
    {
        ...
        frame_1d033c00da0d4a9c8feead1ea9c59233->m_frame.f_lineno = 1;
        {
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_1d033c00da0d4a9c8feead1ea9c59233, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_1d033c00da0d4a9c8feead1ea9c59233->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_1d033c00da0d4a9c8feead1ea9c59233, exception_lineno);
    }



    assertFrameObject(frame_1d033c00da0d4a9c8feead1ea9c59233);
