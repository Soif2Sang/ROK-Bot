...
static PyObject *impl_urllib3$util$queue$$$function__1__init(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_1a368a3cd2d0998e3cdabe48d20042f6 = MAKE_FUNCTION_FRAME(codeobj_1a368a3cd2d0998e3cdabe48d20042f6, module_urllib3$util$queue, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_1a368a3cd2d0998e3cdabe48d20042f6);
...
static PyObject *impl_urllib3$util$queue$$$function__2__qsize(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b15c63048ce3a9fce672b4cf82f40e5f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b15c63048ce3a9fce672b4cf82f40e5f = MAKE_FUNCTION_FRAME(codeobj_b15c63048ce3a9fce672b4cf82f40e5f, module_urllib3$util$queue, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b15c63048ce3a9fce672b4cf82f40e5f);
...
static PyObject *impl_urllib3$util$queue$$$function__3__put(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_d2c175e71d4277512468ceb6512e06c0)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_d2c175e71d4277512468ceb6512e06c0 = MAKE_FUNCTION_FRAME(codeobj_d2c175e71d4277512468ceb6512e06c0, module_urllib3$util$queue, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_d2c175e71d4277512468ceb6512e06c0);
...
static PyObject *impl_urllib3$util$queue$$$function__4__get(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_6024ec814177d320f8eb6a8affe48641)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_6024ec814177d320f8eb6a8affe48641 = MAKE_FUNCTION_FRAME(codeobj_6024ec814177d320f8eb6a8affe48641, module_urllib3$util$queue, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_6024ec814177d320f8eb6a8affe48641);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3db16fb0a8d6706f8f5cc897249e29ab);
    ...
    }
    {
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_value_6, mod_consts[23]);
    ...
    branch_end_2:;
    {
        ...
        frame_9f7460ecd3a38b2f55c3296372ad38fc_2 = MAKE_CLASS_FRAME(codeobj_9f7460ecd3a38b2f55c3296372ad38fc, module_urllib3$util$queue, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_9f7460ecd3a38b2f55c3296372ad38fc_2);
