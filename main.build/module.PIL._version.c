...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("PIL._version"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_PIL$_version(void) {
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_c9416bc02237232db0aaf3f8207795a4 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[9], mod_consts[9], NULL, NULL, 0, 0, 0);
}
...
PyObject *modulecode_PIL$_version(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("PIL._version: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("PIL._version: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_PIL$_version);
...
// Mark the execution in the "__spec__" value.
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_c9416bc02237232db0aaf3f8207795a4);
