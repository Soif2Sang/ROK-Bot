...
static PyObject *impl_numpy$polynomial$polyutils$$$function__2_as_series(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_22 = impl___main__$$$function__7_complex_call_helper_star_list(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_assign_source_10 = IMPORT_NAME(tmp_import_name_from_2, mod_consts[162]);
        }
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        if (PyModule_Check(tmp_import_name_from_3)) {
            ...
            tmp_assign_source_11 = IMPORT_NAME(tmp_import_name_from_3, mod_consts[154]);
        }
