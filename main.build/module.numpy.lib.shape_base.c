...
static PyObject *impl_numpy$lib$shape_base$$$function__7_apply_along_axis(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    try_end_1:;
    {
...

        {
            ...
            tmp_args_element_value_7 = impl___main__$$$function__3_complex_call_helper_pos_star_list_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_args_element_value_11 = impl___main__$$$function__3_complex_call_helper_pos_star_list_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_import_name_from_1 = IMPORT_NAME(tmp_import_name_from_2, mod_consts[121]);
        }
    ...
    tmp_import_from_3__module = NULL;
    {
        ...
        if (PyModule_Check(tmp_import_name_from_15)) {
            ...
            tmp_assign_source_21 = IMPORT_NAME(tmp_import_name_from_15, mod_consts[47]);
        }
