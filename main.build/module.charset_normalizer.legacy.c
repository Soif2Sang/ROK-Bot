...
static PyObject *impl_charset_normalizer$legacy$$$function__1_detect(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_aef8b3a7c5c452f7a6a314e715bfd226 = MAKE_FUNCTION_FRAME(codeobj_aef8b3a7c5c452f7a6a314e715bfd226, module_charset_normalizer$legacy, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_aef8b3a7c5c452f7a6a314e715bfd226);
    ...
    }
    {
        ...
        tmp_sub_expr_right_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_4, mod_consts[13]);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1191f4fac0569df216bdc01635e03cbc);
