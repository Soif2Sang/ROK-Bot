...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_4)) {
            ...
            tmp_assign_source_8 = IMPORT_NAME(tmp_import_name_from_4, mod_consts[147]);
        }
    ...
    branch_yes_2:;
    {
        ...
        tmp_mod_expr_right_1 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_4 = LOOKUP_ATTRIBUTE(tmp_expression_value_6, mod_consts[180]);
            Py_DECREF(tmp_expression_value_6);
            if (tmp_tuple_element_4 == NULL) {
                assert(ERROR_OCCURRED());
    ...
    branch_end_1:;
    {
        ...
        }
        {
            ...
            PyObject *tmp_expression_value_7;
            PyObject *tmp_args_element_value_13;
            tmp_expression_value_7 = PyObject_GetItem(locals_numpy$polynomial$laguerre$$$class__1_Laguerre_1606, mod_consts[21]);
