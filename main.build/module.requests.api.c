...
static PyObject *impl_requests$api$$$function__1_request(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_dadb43fdee1782428bec447dd5269bd2 = MAKE_FUNCTION_FRAME(codeobj_dadb43fdee1782428bec447dd5269bd2, module_requests$api, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_dadb43fdee1782428bec447dd5269bd2);
...
static PyObject *impl_requests$api$$$function__2_get(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_3fc0452c4a4a184e492e6540caf76a14)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_3fc0452c4a4a184e492e6540caf76a14 = MAKE_FUNCTION_FRAME(codeobj_3fc0452c4a4a184e492e6540caf76a14, module_requests$api, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3fc0452c4a4a184e492e6540caf76a14);
...
static PyObject *impl_requests$api$$$function__3_options(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_40e18d19a0d266f2c8d32ec318e71536)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_40e18d19a0d266f2c8d32ec318e71536 = MAKE_FUNCTION_FRAME(codeobj_40e18d19a0d266f2c8d32ec318e71536, module_requests$api, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_40e18d19a0d266f2c8d32ec318e71536);
...
static PyObject *impl_requests$api$$$function__4_head(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_55b74a0be85e1f9694b4c6f5f3b152ef)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_55b74a0be85e1f9694b4c6f5f3b152ef = MAKE_FUNCTION_FRAME(codeobj_55b74a0be85e1f9694b4c6f5f3b152ef, module_requests$api, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_55b74a0be85e1f9694b4c6f5f3b152ef);
...
static PyObject *impl_requests$api$$$function__5_post(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_910a15ff040353618298a7f9d04fd2dc)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_910a15ff040353618298a7f9d04fd2dc = MAKE_FUNCTION_FRAME(codeobj_910a15ff040353618298a7f9d04fd2dc, module_requests$api, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_910a15ff040353618298a7f9d04fd2dc);
...
static PyObject *impl_requests$api$$$function__6_put(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_1031a32fbc7e6185b963e968d692812b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1031a32fbc7e6185b963e968d692812b = MAKE_FUNCTION_FRAME(codeobj_1031a32fbc7e6185b963e968d692812b, module_requests$api, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1031a32fbc7e6185b963e968d692812b);
...
static PyObject *impl_requests$api$$$function__7_patch(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_dc3d130b2bbf1b095db22e954e4b631e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_dc3d130b2bbf1b095db22e954e4b631e = MAKE_FUNCTION_FRAME(codeobj_dc3d130b2bbf1b095db22e954e4b631e, module_requests$api, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_dc3d130b2bbf1b095db22e954e4b631e);
...
static PyObject *impl_requests$api$$$function__8_delete(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2593d04391219ed9fa8fce5d0de130d7)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2593d04391219ed9fa8fce5d0de130d7 = MAKE_FUNCTION_FRAME(codeobj_2593d04391219ed9fa8fce5d0de130d7, module_requests$api, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2593d04391219ed9fa8fce5d0de130d7);
