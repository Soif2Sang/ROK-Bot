...
static PyCodeObject *codeobj_8f504fc396a759ce955d09db49daec3e;
static PyCodeObject *codeobj_95a93859afc185b03b511bdaf5a54d03;
static PyCodeObject *codeobj_a0bd65bea9f2f9ed608813034be486e9;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[14]); CHECK_OBJECT(module_filename_obj);
    codeobj_8f504fc396a759ce955d09db49daec3e = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[15], mod_consts[15], NULL, NULL, 0, 0, 0);
    codeobj_95a93859afc185b03b511bdaf5a54d03 = MAKE_CODE_OBJECT(module_filename_obj, 41, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[1], mod_consts[1], NULL, NULL, 0, 0, 0);
    codeobj_a0bd65bea9f2f9ed608813034be486e9 = MAKE_CODE_OBJECT(module_filename_obj, 45, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[2], mod_consts[2], NULL, NULL, 0, 0, 0);
}
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__1_have_aes_ni(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_95a93859afc185b03b511bdaf5a54d03;
    ...
    static struct Nuitka_FrameObject *cache_frame_95a93859afc185b03b511bdaf5a54d03 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_95a93859afc185b03b511bdaf5a54d03)) {
        Py_XDECREF(cache_frame_95a93859afc185b03b511bdaf5a54d03);

#if _DEBUG_REFCOUNTS
        if (cache_frame_95a93859afc185b03b511bdaf5a54d03 == NULL) {
...
#endif
        cache_frame_95a93859afc185b03b511bdaf5a54d03 = MAKE_FUNCTION_FRAME(codeobj_95a93859afc185b03b511bdaf5a54d03, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
    ...
    assert(cache_frame_95a93859afc185b03b511bdaf5a54d03->m_type_description == NULL);
    frame_95a93859afc185b03b511bdaf5a54d03 = cache_frame_95a93859afc185b03b511bdaf5a54d03;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_95a93859afc185b03b511bdaf5a54d03);
    assert(Py_REFCNT(frame_95a93859afc185b03b511bdaf5a54d03) == 2);
    ...
    // Framed code:
    {
        ...
        frame_95a93859afc185b03b511bdaf5a54d03->m_frame.f_lineno = 42;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_95a93859afc185b03b511bdaf5a54d03, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_95a93859afc185b03b511bdaf5a54d03->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_95a93859afc185b03b511bdaf5a54d03, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_95a93859afc185b03b511bdaf5a54d03,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_95a93859afc185b03b511bdaf5a54d03 == cache_frame_95a93859afc185b03b511bdaf5a54d03) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_95a93859afc185b03b511bdaf5a54d03);
        cache_frame_95a93859afc185b03b511bdaf5a54d03 = NULL;
    }

    assertFrameObject(frame_95a93859afc185b03b511bdaf5a54d03);
...
static PyObject *impl_Crypto$Util$_cpu_features$$$function__2_have_clmul(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Local variable declarations.
    struct Nuitka_FrameObject *frame_a0bd65bea9f2f9ed608813034be486e9;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *tmp_return_value = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_a0bd65bea9f2f9ed608813034be486e9 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_a0bd65bea9f2f9ed608813034be486e9)) {
        Py_XDECREF(cache_frame_a0bd65bea9f2f9ed608813034be486e9);

#if _DEBUG_REFCOUNTS
        if (cache_frame_a0bd65bea9f2f9ed608813034be486e9 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a0bd65bea9f2f9ed608813034be486e9 = MAKE_FUNCTION_FRAME(codeobj_a0bd65bea9f2f9ed608813034be486e9, module_Crypto$Util$_cpu_features, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_a0bd65bea9f2f9ed608813034be486e9->m_type_description == NULL);
    frame_a0bd65bea9f2f9ed608813034be486e9 = cache_frame_a0bd65bea9f2f9ed608813034be486e9;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a0bd65bea9f2f9ed608813034be486e9);
    assert(Py_REFCNT(frame_a0bd65bea9f2f9ed608813034be486e9) == 2);
    ...
    // Framed code:
    {
        ...
        frame_a0bd65bea9f2f9ed608813034be486e9->m_frame.f_lineno = 46;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a0bd65bea9f2f9ed608813034be486e9, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a0bd65bea9f2f9ed608813034be486e9->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a0bd65bea9f2f9ed608813034be486e9, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_a0bd65bea9f2f9ed608813034be486e9,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_a0bd65bea9f2f9ed608813034be486e9 == cache_frame_a0bd65bea9f2f9ed608813034be486e9) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_a0bd65bea9f2f9ed608813034be486e9);
        cache_frame_a0bd65bea9f2f9ed608813034be486e9 = NULL;
    }

    assertFrameObject(frame_a0bd65bea9f2f9ed608813034be486e9);
...
static PyObject *MAKE_FUNCTION_Crypto$Util$_cpu_features$$$function__1_have_aes_ni() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_95a93859afc185b03b511bdaf5a54d03,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_Crypto$Util$_cpu_features$$$function__2_have_clmul() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_a0bd65bea9f2f9ed608813034be486e9,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_8f504fc396a759ce955d09db49daec3e;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    frame_8f504fc396a759ce955d09db49daec3e = MAKE_MODULE_FRAME(codeobj_8f504fc396a759ce955d09db49daec3e, module_Crypto$Util$_cpu_features);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_8f504fc396a759ce955d09db49daec3e);
    assert(Py_REFCNT(frame_8f504fc396a759ce955d09db49daec3e) == 2);
    ...
    }
    {
        ...
        frame_8f504fc396a759ce955d09db49daec3e->m_frame.f_lineno = 31;
    ...
    }
    {
        ...
        frame_8f504fc396a759ce955d09db49daec3e->m_frame.f_lineno = 34;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_8f504fc396a759ce955d09db49daec3e, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_8f504fc396a759ce955d09db49daec3e->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8f504fc396a759ce955d09db49daec3e, exception_lineno);
    }



    assertFrameObject(frame_8f504fc396a759ce955d09db49daec3e);
