...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("oauthlib.oauth2.rfc6749.endpoints.token"));
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_ae0323645dff2201fb1b92147d86b19d = MAKE_FUNCTION_FRAME(codeobj_ae0323645dff2201fb1b92147d86b19d, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_ae0323645dff2201fb1b92147d86b19d);
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__2_grant_types(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_9bcde23e276e9f6f5d2d6d72c623fab6)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_9bcde23e276e9f6f5d2d6d72c623fab6 = MAKE_FUNCTION_FRAME(codeobj_9bcde23e276e9f6f5d2d6d72c623fab6, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_9bcde23e276e9f6f5d2d6d72c623fab6);
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__3_default_grant_type(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_c90b8597ec8818cda64d72ba447ad952)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_c90b8597ec8818cda64d72ba447ad952 = MAKE_FUNCTION_FRAME(codeobj_c90b8597ec8818cda64d72ba447ad952, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_c90b8597ec8818cda64d72ba447ad952);
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__4_default_grant_type_handler(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_681b86766b4865a1e87a37dc2d7f5cab)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_681b86766b4865a1e87a37dc2d7f5cab = MAKE_FUNCTION_FRAME(codeobj_681b86766b4865a1e87a37dc2d7f5cab, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_681b86766b4865a1e87a37dc2d7f5cab);
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__5_default_token_type(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_cb6d95fda197386190942b504d66b051)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_cb6d95fda197386190942b504d66b051 = MAKE_FUNCTION_FRAME(codeobj_cb6d95fda197386190942b504d66b051, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_cb6d95fda197386190942b504d66b051);
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__6_create_token_response(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_8c879fbc6bd114395cc118d14d9b02ed)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_8c879fbc6bd114395cc118d14d9b02ed = MAKE_FUNCTION_FRAME(codeobj_8c879fbc6bd114395cc118d14d9b02ed, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_8c879fbc6bd114395cc118d14d9b02ed);
    ...
    }
    {
        ...
        tmp_args_element_value_6 = LOOKUP_ATTRIBUTE(tmp_expression_value_8, mod_consts[16]);
...
static PyObject *impl_oauthlib$oauth2$rfc6749$endpoints$token$$$function__7_validate_token_request(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_783dbc1f1df386a1b8fdb40b415fa51d)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_783dbc1f1df386a1b8fdb40b415fa51d = MAKE_FUNCTION_FRAME(codeobj_783dbc1f1df386a1b8fdb40b415fa51d, module_oauthlib$oauth2$rfc6749$endpoints$token, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_783dbc1f1df386a1b8fdb40b415fa51d);
...
PyObject *modulecode_oauthlib$oauth2$rfc6749$endpoints$token(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("oauthlib.oauth2.rfc6749.endpoints.token: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("oauthlib.oauth2.rfc6749.endpoints.token: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_oauthlib$oauth2$rfc6749$endpoints$token);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_ccccf942cdc22679dd112a961147e4bb);
    ...
    branch_end_1:;
    {
        ...
        frame_09b7c9edeb0913d41583c16288c21256_2 = MAKE_CLASS_FRAME(codeobj_09b7c9edeb0913d41583c16288c21256, module_oauthlib$oauth2$rfc6749$endpoints$token, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_09b7c9edeb0913d41583c16288c21256_2);
        ...
        }
        {
            ...
            PyObject *tmp_called_value_3;
            PyObject *tmp_args_element_value_2;
            tmp_res = MAPPING_HAS_ITEM(locals_oauthlib$oauth2$rfc6749$endpoints$token$$$class__1_TokenEndpoint_18, mod_consts[59]);
        ...
        branch_no_3:;
        {
            ...
            frame_ccccf942cdc22679dd112a961147e4bb->m_frame.f_lineno = 18;
            tmp_assign_source_18 = CALL_FUNCTION(tmp_called_value_11, tmp_args_value_2, tmp_kwargs_value_2);
