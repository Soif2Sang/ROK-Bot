...
static PyCodeObject *codeobj_338b94db2d287b598f5c554b857041a2;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[22]); CHECK_OBJECT(module_filename_obj);
    codeobj_338b94db2d287b598f5c554b857041a2 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[23], mod_consts[23], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_338b94db2d287b598f5c554b857041a2;
    ...
    frame_338b94db2d287b598f5c554b857041a2 = MAKE_MODULE_FRAME(codeobj_338b94db2d287b598f5c554b857041a2, module_charset_normalizer$assets);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_338b94db2d287b598f5c554b857041a2);
    assert(Py_REFCNT(frame_338b94db2d287b598f5c554b857041a2) == 2);
    ...
    // Framed code:
    {
        ...
        frame_338b94db2d287b598f5c554b857041a2->m_frame.f_lineno = 1;
        {
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_338b94db2d287b598f5c554b857041a2, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_338b94db2d287b598f5c554b857041a2->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_338b94db2d287b598f5c554b857041a2, exception_lineno);
    }



    assertFrameObject(frame_338b94db2d287b598f5c554b857041a2);
