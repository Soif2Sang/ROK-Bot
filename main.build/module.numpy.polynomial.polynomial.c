...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_4)) {
            ...
            tmp_assign_source_9 = IMPORT_NAME(tmp_import_name_from_4, mod_consts[140]);
        }
    ...
    }
    {
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_value_5, mod_consts[170]);
    ...
    branch_yes_2:;
    {
        ...
        tmp_mod_expr_right_1 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_4 = LOOKUP_ATTRIBUTE(tmp_expression_value_6, mod_consts[172]);
            Py_DECREF(tmp_expression_value_6);
            if (tmp_tuple_element_4 == NULL) {
                assert(ERROR_OCCURRED());
