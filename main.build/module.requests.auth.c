...
// Mark the execution in the "__spec__" value.
    ...
    branch_yes_2:;
    {
        ...
        tmp_mod_expr_right_1 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_4 = LOOKUP_ATTRIBUTE(tmp_expression_value_5, mod_consts[171]);
            Py_DECREF(tmp_expression_value_5);
            if (tmp_tuple_element_4 == NULL) {
                assert(ERROR_OCCURRED());
    ...
    branch_yes_4:;
    {
        ...
        tmp_called_value_4 = LOOKUP_ATTRIBUTE(tmp_expression_value_8, mod_consts[167]);
        if (tmp_called_value_4 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_5:;
    {
        ...
        tmp_mod_expr_right_2 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_8 = LOOKUP_ATTRIBUTE(tmp_expression_value_10, mod_consts[171]);
            Py_DECREF(tmp_expression_value_10);
            if (tmp_tuple_element_8 == NULL) {
                assert(ERROR_OCCURRED());
    ...
    branch_yes_7:;
    {
        ...
        tmp_called_value_6 = LOOKUP_ATTRIBUTE(tmp_expression_value_13, mod_consts[167]);
        if (tmp_called_value_6 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_8:;
    {
        ...
        tmp_mod_expr_right_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_12 = LOOKUP_ATTRIBUTE(tmp_expression_value_15, mod_consts[171]);
            Py_DECREF(tmp_expression_value_15);
            if (tmp_tuple_element_12 == NULL) {
                assert(ERROR_OCCURRED());
