...
from src.tasks.Task_clear_fog import ClearFog
from src.tasks.Task_collect_resource import CollectResource
from src.tasks.Task_daily_chest import DailyChest
from src.tasks.Task_daily_vip import DailyVip
from src.tasks.Task_enhanced_buff import UseEnhancedBuff
from src.tasks.Task_gather_gem_default import GatherGemDefault
from src.tasks.Task_gather_rss_default import GatherRssDefault
from src.tasks.Task_gather_rss_zoom import GatherRssZoom
from src.tasks.Task_heal_troop import HealTroop
from src.tasks.Task_hunt_barbarians import HuntBarbarians
from src.tasks.Task_maraudeurs_default import Marauders
from src.tasks.Task_produce_materials import ProduceMaterials
...
from src.tasks.TaskPC import Task
from src.tasks.TaskPC_gather_gem_spiral import GatherGemSpiral
from src.utils.bridge.android_debug_bridge import DeviceNotFoundException
...
from src.utils.functions import current_time, get_dic_instances, get_dic_instances_ld, get_name, get_window_pid
from src.utils.bridge.pc_bridge import PcBridge
from src.utils.singletons import EmulatorSingleton
from src.views.frametime import is_slot_runnable, random_time_in_frametime
            ...
            for enabled_tile in tiles:
                ...
                for profile in self.data[self.sel]["schedules"]:
                    ...
                    if emulator == "bluestacks":
                        ...
                        self.adb = PcBridge(self.tile.number, task_reference=self)
