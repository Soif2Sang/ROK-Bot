...
from src.tasks.Task_gather_gem import GatherGem
...
from src.tasks.Task_alliance_build import AllianceBuilding
...
from src.tasks.Task_maraudeurs_map import Marauders
...
from src.utils.functions import current_time, get_dic_instances, get_dic_instances_ld, get_name, get_window_pid, rgetattr, \
    get_class
