...
blacklisted_subdirectories = ['.git', '.idea', '__pycache__', 'venv', 'character', 'Crypto', 'easyocr', 'flet_toast', 'models', 'twocaptcha', 'auth compiled', 'Include', 'Lib', 'logs', 'Scripts', 'taskscod', 'tesseract', 'viewscod']
