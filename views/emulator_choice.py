...
class EmulatorChoice(ft.ResponsiveRow):
    ...
    def go_main(self, e):
        ...
        print(f"{EmulatorSingleton().getEmulator() =}")
    ...
    def init(self):
        blue = ft.Container(content=ft.Image(
            src=f"bluestacks_logo.png",
            width=70,
            height=70,
            fit=ft.ImageFit.CONTAIN,
        ),bgcolor=ft.colors.GREY_900, col=6, width=100, height=100, padding=20, border=ft.border.all(2, ft.colors.GREY_700), on_click=self.go_main, data="bluestacks")

        ld = ft.Container(content=ft.Image(
            src=f"ld_logo.png",
            width=80,
            height=80,
            fit=ft.ImageFit.CONTAIN,
        ),bgcolor=ft.colors.GREY_900, col=6, width=100, height=100, padding=20, border=ft.border.all(2, ft.colors.GREY_700), on_click=self.go_main, data="ld")
