...
,
                         subtitle=translate("If you use the normal way to upgrade the city, you have to configure the city hall position!",
                                            )),

            ft.Switch(
                label=translate("Use normal way to upgrade the city \n(if unchecked the bot is unable to upgrade the pass but \nit is a safer way to upgrade the city)"),
        ...
        self.add_control(
            ft.OutlinedButton(icon=ft.icons.GPS_FIXED_SHARP, text=translate("Set City Hall Position")
,
