...
ALLOWED_SIGNUP_USER_ID = os.getenv("ALLOWED_SIGNUP_USER_ID")
...
def sellix_webhook():
    ...
    try:
        ...
        signature = hmac.new(SELLIX_WEBHOOK_SECRET, payload, hashlib.sha512).hexdigest()
...
def create_user():
    ...
    if data['user_id'] != ALLOWED_SIGNUP_USER_ID:
        return jsonify({'error': 'Missing email or password'}), 400
