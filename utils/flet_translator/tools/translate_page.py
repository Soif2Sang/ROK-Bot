...
class TranslateFletPage:
    ...
    def __init__(
        ...
        if isinstance(skiped_classes, list):
            self.skiped_classes = skiped_classes
        else:
            self.skiped_classes = []
